...
const Root: React.FC<IPropsContents> = ({ childrenContents, flex }) => {
  return <ContentsText flex={flex}>{childrenContents}</ContentsText>;
};
...
const Title: React.FC<IPropsTitle> = ({ textTitle }) => (
  <FirstTitle>{textTitle}</FirstTitle>
);
...
const WhatWe: React.FC<IPropsWhatWe> = ({ childrenWhatWe }) => {
  return <WhatWeDoOrAre>{childrenWhatWe}</WhatWeDoOrAre>;
};
...
const Subtitle: React.FC<IPropsSubtitle> = ({ textSubtitle }) => (
  <Secondtitle>{textSubtitle}</Secondtitle>
);
...
const Desc: React.FC<IPropsDesc> = ({ textDesc }) => (
  <Paragraph>{textDesc}</Paragraph>
);
...
const Button: React.FC<IPropsButton> = ({ childrenButton }) => (
  <ButtonLearn>{childrenButton}</ButtonLearn>
);
